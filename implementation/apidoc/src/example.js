 ...
 * @apiParam {String} [fillColour.hex] Hex value. Takes precedence over individual colour values.
 ...
 * @apiParam {String} [strokeColour.hex] Hex value. Takes precedence over individual colour values.
